...
- [Transducer models](transducer-models.md) — flat and cylindrical elements
  (exact elliptic, lookup table, trapezoidal), point quadrature for any
  surface, and their accuracy/speed trade-offs.
